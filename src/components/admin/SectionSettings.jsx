...
export default function SectionSettings() {
  const { langSettings, setLangSettings, about } = useContent();
  ...
  return (
    <div>
      ...
      <div className="info-panel">
        ...
        <div className="storage-row"><span>Kontak</span><strong>{about?.email || 'prizurihartadi10@gmail.com'}</strong></div>
      </div>
    </div>
  );
}